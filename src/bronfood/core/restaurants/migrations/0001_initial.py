    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_archived",
                    models.BooleanField(default=False, verbose_name="Архивировано ли"),
                ),
                (
                    "rating",
                    models.PositiveIntegerField(max_length=5, verbose_name="Рейтинг"),
                ),
                (
                    "pic",
                    models.ImageField(
                        upload_to="pics", verbose_name="Изображение меню"
                    ),
                ),
                (
                    "dishes",
