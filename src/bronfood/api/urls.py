...
urlpatterns = [
    ...
    path('api/basket/', BasketViewSet.as_view({'get': 'list'}), name='api_basket_get'),
    ...
    path('basket/<int:mealId>', BasketViewSet.as_view({'delete': 'remove_meal'}), name='basket-delete-meal'),
]
